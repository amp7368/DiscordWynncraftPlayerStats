package apple.playerStats;

import apple.playerStats.discord.DiscordBot;
...
public class StatsMain {
    private static final String APPLICATION_NAME = "PlayerStatsBot";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = StatsMain.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    /**
     * new: https://docs.google.com/spreadsheets/d/17dheMIUDh0O6Xx4hupUL1aR89HCByOe9T-8m-BQUJCk/edit
     */
